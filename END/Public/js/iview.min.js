...
var CitySvg = function (_React$Component) {
  ...
  CitySvg.prototype.render = function render() {
    ...
    return React.createElement(
      'svg',
      { xmlns: 'http://www.w3.org/2000/svg', ref: function ref(c) {
          return _this2.wrapper1 = c;
        }, viewBox: '0 0 1031.41 441.18', className: 'container' },
      React.createElement(
        'g',
        { className: 'house', id: 'house-seven', ref: function ref(h) {
            return _this2.houseSeven = h;
          }, 'data-project': 6, onClick: function onClick(e) {
            return _this2.mouseAction(e);
          } },
        React.createElement(
          'g',
          { id: 'bg-fill-2', className: 'bg-fill' },
          React.createElement('path', { fill: '#e82c84', d: 'M904.92 271.63H843.7v5.98h4.06v112.88h53.1V277.61h4.06v-5.98z' }),
          React.createElement('path', { fill: '#f079b2', d: 'M844.65 272.59h59.07v5.02h-59.07zm23.92 27.16V285.5h-12.44v14.25h-2.22v4.22h16.32v-4.22h-1.66zm24.08 0V285.5h-12.44v14.25h-2.22v4.22h16.31v-4.22h-1.65zm0 27.38v-14.24h-12.44v14.24h-2.22v4.23h16.31v-4.23h-1.65zm-23.96 0v-14.24h-12.44v14.24h-2.23v4.23h16.32v-4.23h-1.65zm0 27.62V340.5h-12.44v14.25h-2.23v4.22h16.32v-4.22h-1.65zm24.42 0V340.5h-12.44v14.25h-2.23v4.22h16.32v-4.22h-1.65zm-24.42 26.81v-14.24h-12.44v14.24h-2.23v4.23h16.32v-4.23h-1.65zm11.69-14.49h12.21v23.51h-12.21z' })
        ),
        React.createElement(
          'g',
          { id: 'stroke-2' },
      ...
      React.createElement(
        'g',
        { className: 'house', id: 'house-six', ref: function ref(h) {
            return _this2.houseSix = h;
          }, 'data-project': 5, onClick: function onClick(e) {
            return _this2.mouseAction(e);
          } },
        React.createElement(
          'g',
          { id: 'bg-fill', className: 'bg-fill' },
          React.createElement('path', { fill: '#bd9ec9', d: 'M751.19 225.73h27.99v165.55h-27.99z' }),
      ...
      React.createElement(
        'g',
        { className: 'house', id: 'house-three', ref: function ref(h) {
            return _this2.houseThree = h;
          }, 'data-project': 2, onClick: function onClick(e) {
            return _this2.mouseAction(e);
          } },
        React.createElement(
          'g',
          { id: 'bg-fill-5', className: 'bg-fill' },
          React.createElement('path', { fill: '#18a9e2', d: 'M368.86 301.21h48.57v89.63h-48.57z' }),
          React.createElement('path', { fill: '#0d729e', d: 'M366.93 305.74h51.61v3.66h-51.61zm0 17.09h51.61v3.66h-51.61zm0 17.09h51.61v3.66h-51.61zm0 16.91h51.61v3.66h-51.61zm0 17.26h51.61v3.66h-51.61zm14.71 7.86h22.89v9.23h-22.89zm9.09-82.94h17.08v2.75h-17.08z' })
        ),
        React.createElement(
          'g',
          { id: 'stroke-5', 'data-name': 'stroke' },
...
ReactDOM.render(React.createElement(App, null), document.querySelector(".wrapper1"));